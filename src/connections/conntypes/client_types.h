...
/**
 * Client base connection which is all other type of client connection implementing this.
 */
typedef struct 
{
    /**
...
/**
 * Client plain connection properties.
 */
typedef struct 
{
    /**
...
/**
 * Client ssl connection properties.
 */
typedef struct 
{
    /**
